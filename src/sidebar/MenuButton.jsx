...
class MenuButton extends Component {
  ...
  getTools = () => {
    let itemList = [];
    window.appConfig.sidebarToolComponents.forEach(tool => {
  ...
  getThemes = () => {
    let itemList = [];
    window.appConfig.sidebarThemeComponents.forEach(tool => {
  ...
  getOthers = () => {
    ...
    itemList.push(<MenuItem onClick={() => helpers.showURLWindow(window.appConfig.helpUrl, false, "full")} key={helpers.getUID()} name={"Help"} iconClass={"sc-menu-help-icon"} />);
    itemList.push(
      <MenuItem onClick={() => helpers.showURLWindow(window.appConfig.termsUrl, false, "full")} key={helpers.getUID()} name={"Terms and Conditions"} iconClass={"sc-menu-terms-icon"} />
    );
    return itemList;
  };
