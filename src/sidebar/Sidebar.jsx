...
import TOC from "./components/wms/TOC";
      ...
      if (loadedTool != null) {
        ...
        this.state.toolComponents.map(Component => {
          if (Component.props.name === name) {
            ...
            console.log("compoent in sidebar..."+comp);
            this.setState({ activeTabComponents: activeTabComponents });
            return comp;
          } else return null;
        });
          ...
          <React.Fragment>
            <Tabs forceRenderTabPanel={true} selectedIndex={this.state.tabIndex} onSelect={this.onTabSelect}>
              <TabList>
                ...
                {/* <Tab id="tab-layers">
                  <TabButton imageURL={images["legend-32x32.png"]} name="WMS Layers" />
                </Tab> */}
                {/* <Tab id="tab-mapview">
                  <TabButton imageURL={images["myview.png"]} name="View" />
                </Tab> */}
               {/* <Tab id="tab-mymaps">
              ...
              <TabPanel id="tab-layers-content">{this.state.activeTabComponents.mapview}</TabPanel>
