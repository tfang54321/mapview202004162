...
// CUSTOM
import LayerItem from "./OverLayerItem.jsx";
import * as helpers from "../../../helpers/helpers";
import "./VirtualOverLayers.css";
...
const SortableItem = sortableElement(({ value, style, item, onLegendToggle, onCheckboxChange, searchText, onLayerOptionsClick }) => {
  ...
  return (
    <li style={style} className="mv-virtual-layer-list-item sc-noselect" id={item.elementId}>
...
class VirtualLayers extends Component {
  ...
  render() {
    ...
    return (
      <List
        id="mv-overlayer-virtual-sortedlayers" //just the id of this list
        ref={getRef}
