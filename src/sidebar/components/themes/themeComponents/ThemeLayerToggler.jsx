  ...
  handleUrlParameter = () => {
    ...
    helpers.getWFSGeoJSON(
      ...
      result => {
        ...
        window.popup.show(center, <ThemePopupContent key={helpers.getUID()} values={entries} popupLogoImage={this.props.window.appConfig.popupLogoImage} layerConfig={this.props.layerConfig} />, this.props.layerConfig.displayName);
      },
      null,
      null,
      query
