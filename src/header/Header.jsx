...
class Header extends Component {
  ...
  onFeedbackClick = () => {
    ...
    const feedbackUrl = feedbackTemplate(window.appConfig.feedbackUrl, xmin, xmax, ymin, ymax, center[0], center[1], scale);
  ...
  getRenderContent = () =>{
    ...
    if(window.appConfig.BLI_Under_Dev.Dev_MenuOnly) {
      context = (
        ...
        <div id="sc-header-erase-rest" ></div>
        </div>
        )
    }
    else {
      context = (
        <div className="header">
          ...
          <div id="sc-header-bar-logo">
            <img src={require("./images/" + window.appConfig.headerLogoImageName)} alt="Header Logo" />
          </div>
  ...
  // render() {
  //   const imageName = window.appConfig.headerLogoImageName;
  //   return (
  //     <div className="header">
  //       <div
  //         id="sc-header-burger-button"
